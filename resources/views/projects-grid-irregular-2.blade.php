          ...
          <section class="section section-grid section-content overflow bg-light-1 pt-large pb-medium" data-arts-os-animation="data-arts-os-animation" data-grid-columns="2" data-grid-tablet="1" data-grid-mobile="1">
            <div class="container-fluid">
              ...
              <div class="grid grid_fluid-4 js-grid">
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-identity">
                  <div class="section-grid__item"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-8-halfscreen-right-left.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-8.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
                        <h2 class="h3 figure-project__heading">Minimalex Cosmetics</h2>
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-identity">
                  <div class="section-grid__item section-grid__item_padding"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-6-bottom-fullwidth.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-6.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
                        <h2 class="h3 figure-project__heading">Paysage Fiction</h2>
                        <div class="figure-project__category mt-md-1 mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover change-text-hover_has-line text-left">
                            <!-- label by default -->
                            <div class="change-text-hover__normal js-split-text split-text js-change-text-hover__normal" data-split-text-type="lines" data-split-text-set="lines">Identity</div>
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-branding">
                  <div class="section-grid__item section-grid__item_padding"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-13-bottom-container-center.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-13_vertical.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
                        <h2 class="h3 figure-project__heading">Arrigo Casual Accessories</h2>
                        <div class="figure-project__category mt-md-1 mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover change-text-hover_has-line text-left">
                            <!-- label by default -->
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-ui-ux-design">
                  <div class="section-grid__item"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-3-halfscreen-left-right.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-3.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-photography">
                  <div class="section-grid__item section-grid__item_padding"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-10-halfscreen-left-right.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-10.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
                        <h2 class="h3 figure-project__heading">Kinsey Premium Furniture</h2>
                        <div class="figure-project__category mt-md-1 mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover change-text-hover_has-line text-left">
                            <!-- label by default -->
                ...
                <!---->
                <div class="grid__item grid__item_desktop-6 grid__item_tablet-12 grid__item_mobile-12 grid__item_fluid-4 js-grid__item category-branding">
                  <div class="section-grid__item"><a class="figure-project hover-zoom js-change-text-hover" href="project-details-4-halfscreen-left-left.html" data-pjax-link="flyingImage">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-project__wrapper-img js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy js-transition-img__transformed-el"><img data-src="img/assets/projects/project-4.jpg" src="#" alt="" width="1920" height="1920"/></div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-project__content pl-md-2 pt-md-2 pt-1 pl-0">
