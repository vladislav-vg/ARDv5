    ...
    <div data-barba="wrapper">
      ...
      <div class="js-smooth-scroll bg-light-3" id="page-wrapper" data-barba="container">
        <main class="page-wrapper__content">
          <!-- section MASTHEAD BOTTOM FULLWIDTH -->
              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col">
                  ...
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="h1 mt-0 mb-0">Paysage Fiction</h1>
                  </div>
                  <div class="w-100"></div>
            ...
            <div class="section-image section-masthead__background section section_h-900 mt-medium">
              <div class="section-image__wrapper js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                <div class="js-transition-img__transformed-el">
                  <div class="lazy-bg" data-src="img/assets/projects/project-6.jpg"></div>
                </div>
              </div>
            </div>
          </section>
              ...
              <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                  <section class="section section-content clearfix" data-arts-os-animation="data-arts-os-animation">
                    <div class="section-content__inner">
                      <div class="w-100"></div>
                      <div class="section-content__text split-text js-split-text mt-md-2 mt-1" data-split-text-type="lines" data-split-text-set="lines">
                        <p>Late hour new nay able fat each sell. Nor themselves age introduced frequently use unsatiable devonshire get. They why quit gay cold rose deal park. One same they four did ask busy. Reserved opinions fat him nay position. Breakfast as zealously incommode do agreeable furniture. One too nay led fanny allow plate.</p>
                      </div>
                    </div>
                  </section>
                </div>
          ...
          <div class="container section-grid js-gallery" data-arts-os-animation>
            <div class="row mt-medium mb-medium">
              <div class="col">
                <div class="section-grid__item">
                  <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project6/img-6-1.jpg" data-size="2240x1500" data-title="MOKI Identity">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-image__wrapper-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy"><img data-src="img/assets/project6/img-6-1_thumb.jpg" src="#" alt="" width="1120" height="750"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-center">
                        <div class="figure-image__wrapper-caption paragraph">MOKI Identity</div>
                      </div></a></div>
                </div>
              </div>
            </div>
            <div class="row mt-medium mb-medium justify-content-center">
              <div class="col-lg-8">
                <div class="section-grid__item">
                  <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project6/img-6-2.jpg" data-size="1460x1460" data-title="Design Building Block">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-image__wrapper-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy"><img data-src="img/assets/project6/img-6-2_thumb.jpg" src="#" alt="" width="730" height="730"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-center">
                        <div class="figure-image__wrapper-caption paragraph">Design Building Block</div>
                      </div></a></div>
                </div>
              </div>
            </div>
            <div class="row mt-medium mb-medium">
              <div class="col-lg-8">
                <div class="section-grid__item">
                  <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project6/img-6-3.jpg" data-size="1460x1460" data-title="Sophisticated Style">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-image__wrapper-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy"><img data-src="img/assets/project6/img-6-3_thumb.jpg" src="#" alt="" width="730" height="730"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-right">
                        <div class="figure-image__wrapper-caption paragraph">Sophisticated Style</div>
                      </div></a></div>
                </div>
              </div>
            </div>
            <div class="row mt-medium mb-medium justify-content-end">
              <div class="col-lg-8">
                <div class="section-grid__item">
                  <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project6/img-6-4.jpg" data-size="1460x1460" data-title="Premium Materials">
                      <div class="hover-zoom__inner">
                        <div class="hover-zoom__zoom">
                          <div class="figure-image__wrapper-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                            <div class="lazy"><img data-src="img/assets/project6/img-6-4_thumb.jpg" src="#" alt="" width="730" height="730"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-left">
                        <div class="figure-image__wrapper-caption paragraph">Premium Materials</div>
                      </div></a></div>
                </div>
              </div>
            </div>
          ...
          <!-- - IMAGES GALLERY BLOCK -->
          <!-- section VIDEO -->
          <section class="section section-video section-content section-image js-gallery section-offset offset_bottom container-fluid bg-dark-2 pt-medium mb-medium" data-arts-os-animation="data-arts-os-animation" data-grid-columns="1" data-grid-tablet="1" data-grid-mobile="1" data-arts-theme-text="light">
            <div class="section-offset__content">
              ...
              <div class="section-video__container section section_h-700 section-content__image"><a class="section-video__link" href="https://www.youtube.com/watch?v=2d1VrCvdzbY" data-autoplay="data-autoplay">
                ...
                <div class="col-lg-6">
                  <section class="section section-content clearfix" data-arts-os-animation="data-arts-os-animation">
                    <div class="section-content__inner">
                      <div class="w-100"></div>
                      <div class="section-content__text split-text js-split-text mt-md-2 mt-1" data-split-text-type="lines" data-split-text-set="lines">
                        <p><strong>Awwwards: Site of the Day</strong></p>
                        <p><strong>Awwwards: Developer Award</strong></p>
                        <p><strong>Awwwards: Mobile Excellence Award</strong></p>
                        <p><strong>CSS Design Awards: Website of the Day</strong></p>
                      </div>
                    </div>
                  </section>
                </div>
          ...
          <section class="container-fluid section section-nav-projects section-fullheight text-center" data-arts-os-animation="data-arts-os-animation">
            <div class="section-fullheight__inner section-nav-projects__inner_actual">
              ...
              <header class="section-nav-projects__header"><a class="section-nav-projects__link" href="project-details-7-fullscreen-left.html" data-pjax-link="flyingImage">
                  <div class="section-nav-projects__subheading small-caps mb-1 mb-md-2">Next Project</div>
                  <h2 class="section-nav-projects__heading h1 mt-0 mb-0">Silence &amp; Noise</h2></a></header>
            ...
            <div class="container section-nav-projects__next-image section-fullheight__inner">
              <div class="section-nav-projects__wrapper-image js-transition-img overflow">
                <div class="lazy js-transition-img__transformed-el"><img class="of-cover" src="#" data-src="img/assets/projects/project-7.jpg" alt="" width="1920" height="1280"/></div>
              </div>
            </div>
