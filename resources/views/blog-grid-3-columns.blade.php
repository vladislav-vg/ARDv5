    ...
    <div data-barba="wrapper">
      ...
      <div class="js-smooth-scroll bg-light-1" id="page-wrapper" data-barba="container">
        <main class="page-wrapper__content">
              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col-lg-8">
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="h1 mt-0 mb-0">Blog II</h1>
                  </div>
                  <div class="w-100"></div>
          ...
          <!-- - section MASTHEAD -->
          <!-- section BLOG GRID -->
          <section class="section section-blog section-grid section-content overflow pb-medium" data-arts-os-animation="data-arts-os-animation" data-grid-columns="3" data-grid-columns-tablet="2" data-grid-columns-mobile="1">
            <!-- filter -->
                    ...
                    <div class="filter__inner">
                      <div class="container-fluid no-gutters">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-xl-auto col-12 filter__item js-filter__item" data-filter=".category-videography">
              ...
              <div class="row">
                <div class="col section-blog__posts">
                  ...
                  <div class="grid grid_fluid-4 js-grid">
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy grid__sizer js-grid__sizer"></div>
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-lifestyle">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-1-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                          ...
                          <!-- - post featured image -->
                          <!-- post header & info  -->
                          <div class="figure-post__header pt-1"><a class="d-block" href="blog-grid-single-post-1.html">
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-photography">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-2-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-photography">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-3-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-lifestyle">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-4-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-interviews">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-5-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-tips-&amp;-tricks">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-6-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                              <time class="figure-post__date figure-post__date_small" datetime="2020-02-01T04:16:44+00:00"><span class="figure-post__date-day h4">15</span><span class="figure-post__date-month">Feb</span></time>
                              <!-- - post date --></a></div>
                          <!-- - post featured image -->
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-videography">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-7-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                              <time class="figure-post__date figure-post__date_small" datetime="2020-02-01T04:16:44+00:00"><span class="figure-post__date-day h4">13</span><span class="figure-post__date-month">Feb</span></time>
                              <!-- - post date --></a></div>
                          <!-- - post featured image -->
                          <!-- post header & info  -->
                          <div class="figure-post__header pt-1"><a class="d-block" href="blog-grid-single-post-1.html">
                              <h2 class="h4 mt-0">Choosing The Right Path</h2></a>
                            <ul class="figure-post__categories small-caps">
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-interviews">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-8-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                              <time class="figure-post__date figure-post__date_small" datetime="2020-02-01T04:16:44+00:00"><span class="figure-post__date-day h4">12</span><span class="figure-post__date-month">Feb</span></time>
                              <!-- - post date --></a></div>
                          <!-- - post featured image -->
                          <!-- post header & info  -->
                          <div class="figure-post__header pt-1"><a class="d-block" href="blog-grid-single-post-1.html">
                              <h2 class="h4 mt-0">A Brief History Of Creation</h2></a>
                            <ul class="figure-post__categories small-caps">
                              <li><a href="#">Interviews</a></li>
                            </ul>
                          </div>
                    ...
                    <div class="grid__item grid__item_desktop-4 grid__item_tablet-6 grid__item_mobile-12 grid__item_fluid-4 grid__item_fluid-4-fancy js-grid__item category-tips-&amp;-tricks">
                      <div class="section-grid__item">
                        <article class="figure-post">
                          <!-- post featured image -->
                          <div class="figure-post__media"><a class="lazy" href="blog-grid-single-post-1.html"><img data-src="img/assets/sectionBlog/post-9-thumb.jpg" width="960" height="960" src="#" alt=""/>
                              <!-- post date -->
                              <time class="figure-post__date figure-post__date_small" datetime="2020-02-01T04:16:44+00:00"><span class="figure-post__date-day h4">10</span><span class="figure-post__date-month">Feb</span></time>
                              <!-- - post date --></a></div>
                          <!-- - post featured image -->
                          <!-- post header & info  -->
                          <div class="figure-post__header pt-1"><a class="d-block" href="blog-grid-single-post-1.html">
                              <h2 class="h4 mt-0">Althusser Competing Interpellations And The Third Text</h2></a>
                            <ul class="figure-post__categories small-caps">
                              <li><a href="#">Tips &amp; Tricks</a></li>
                            </ul>
                          </div>
