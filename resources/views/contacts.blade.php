              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col-lg-8">
                  ...
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="mt-0 mb-0 h2"> {{ $contacts->title }} </h1>
                  </div>
                  <div class="w-100"></div>
                    ...
                    <div class="bg-white container-fluid py-md-3 py-1">
                      <div class="section-properties__item my-2">
                        <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                          <div class="figure-info__option small-caps">Studio</div>
                          <div class="figure-info__value paragraph">Tigina, 49/3, office 37<br>Kishinev<br>MOLDOVA</div>
                        </div>
                      </div>
                      <div class="section-properties__item my-2">
                        <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                          <div class="figure-info__option small-caps">Want to Talk?</div>
                          <div class="figure-info__value paragraph"><a href="mailto:rhye@example.com">ard_md@hotbox.ru</a><br>(+373 22) 888060</div>
                        </div>
                      </div>
                      <div class="section-properties__item my-2">
                        <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <section class="section section-form pb-medium">
                  <form class="form form-contact js-ajax-form bg-white form-contact_paddings" action="mail.php" method="POST" data-message-success="Thanks for your message! We will reply you as soon as possible." data-message-error="Something went wrong :( Please contact me directly at &lt;a href=&quot;rhye@example.com&quot;&gt;rhye@example.com&lt;/a&gt;">
                    <!-- header -->
              ...
              <div class="col-lg-7">
                <div class="row justify-content-lg-between">
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <section class="widget widget_nav_menu">
                      <!-- header -->
                      <h2 class="widgettitle">Test 2</h2>
                      <!-- - header -->
                      <!-- content -->
                      <ul class="menu js-menu">
                        <li><a href="project-details-8-halfscreen-right-left.html">Lorem ipsum</a>
                        </li>
                        <li><a href="project-details-9-fullscreen-center.html">Lorem ipsum</a>
                        </li>
                        <li><a href="project-details-10-halfscreen-left-right.html">Lorem ipsum</a>
                        </li>
                        <li><a href="project-details-11-fullscreen-center.html">Lorem ipsum</a>
                        </li>
                        <li><a href="project-details-12-bottom-container-center.html">Lorem ipsum</a>
                        </li>
                      </ul>
                      <!-- - content -->
                    </section>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-3 footer__column text-center text-lg-left order-lg-1">
                <section class="widget widget_rhye_logo">
                  <!-- content --><a class="logo" href="home.php" target="_blank">
                    <div class="logo__wrapper-img">
                      <!-- primary logo version (for light backgrounds)--><img class="logo__img-primary" src="img/ard/logo.png" alt="Rhye HTML5 Template" height="20" style="height: 5rem; width: auto;"/>
                      <!-- secondary logo version (for dark backgrounds)--><img class="logo__img-secondary" src="img/ard/logo-white.png" alt="Rhye HTML5 Template" height="20" style="height: 5rem; width: auto;"/>
                    </div></a>
                  <!-- - content -->
                </section>
              </div>
