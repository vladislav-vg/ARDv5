                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            ...
                            <div class="slider__text js-split-text split-text mb-1" data-split-text-type="lines" data-split-text-set="lines">
                              <p>He difficult contented we determine ourselves me am earnestly. Hour no find it park. Eat welcomed any husbands moderate. Led was misery played waited almost.</p>
                            </div>
                            <div class="slider__wrapper-button mt-2"><a class="button button_black button_solid" data-hover="Explore Project" href="project-details-1-fullscreen-center.html"><span class="button__label-hover">Explore Project</span></a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="small-caps slider__subheading js-split-text split-text mb-1" data-split-text-type="lines, words, chars" data-split-text-set="chars">Portraits</div>
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="slider__wrapper-button mt-2"><a class="button button_black button_solid" data-hover="Explore Project" href="project-details-11-fullscreen-center.html"><span class="button__label-hover">Explore Project</span></a>
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="small-caps slider__subheading js-split-text split-text mb-1" data-split-text-type="lines, words, chars" data-split-text-set="chars">Portraits</div>
                            ...
                            <div class="slider__wrapper-button mt-2"><a class="button button_black button_solid" data-hover="Explore Project" href="project-details-12-bottom-container-center.html"><span class="button__label-hover">Explore Project</span></a>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-1_thumb.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-2_thumb.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-5_thumb.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-9_thumb.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-11_thumb.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg swiper-lazy" data-background="img/assets/projects/project-12_thumb.jpg"></div>
                            </div>
                          </div>
                        </div>
                      </div>
