        ...
        <main class="page-wrapper__content">
              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col">
                  ...
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="h1 mt-0 mb-0">Arrigo Casual Accessories</h1>
                  </div>
                  <div class="w-100"></div>
                ...
                <section class="section section-content clearfix pt-medium text-center" data-arts-os-animation="data-arts-os-animation">
                  <div class="section-content__inner">
                    ...
                    <div class="section-content__heading split-text js-split-text mb-2" data-split-text-type="lines,words" data-split-text-set="words">
                      <h3>In a market that’s often more focused on functionality than good looks, Rhye stands out as a beautifully designed product. The templates set out to emphasize that.</h3>
                    </div>
                    <div class="w-100"></div>
                    <div class="section-content__button mt-2"><a class="button button_solid button_white" data-hover="View Website" href="#"><span class="button__label-hover">View Website</span></a>
                    </div>
                  </div>
                </section>
              </div>
            ...
            <div class="container">
              <div class="row section mt-medium mb-medium">
                <div class="col-12">
                  <div class="section-grid__item">
                    <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project13/img-13-1.jpg" data-size="2240x1500" data-title="Moki Branding">
                        ...
                        <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-center">
                          <div class="figure-image__wrapper-caption paragraph">Moki Branding</div>
                        </div></a></div>
                  </div>
                </div>
              </div>
              <div class="row section mt-medium mb-medium">
                <div class="col-lg-7 offset-lg-4">
                  <div class="section-grid__item">
                    <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project13/img-13-2.jpg" data-size="1460x1460" data-title="Building Block">
                        <div class="hover-zoom__inner">
                          <div class="hover-zoom__zoom">
                            <div class="figure-image__wrapper-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                        ...
                        <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-left">
                          <div class="figure-image__wrapper-caption paragraph">Building Block</div>
                        </div></a></div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="section-grid__item">
                    <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project13/img-13-3.jpg" data-size="1460x1460" data-title="Perfect Gift">
                        ...
                        <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-right">
                          <div class="figure-image__wrapper-caption paragraph">Perfect Gift</div>
                        </div></a></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-5 offset-lg-5">
                  <div class="section-grid__item">
                    <div class="figure-image section-image"><a class="hover-zoom figure-image__link" data-arts-cursor="data-arts-cursor" data-arts-cursor-scale="1.6" data-arts-cursor-icon="add" data-arts-cursor-hide-native="true" href="img/assets/project13/img-13-4.jpg" data-size="1460x1460" data-title="Minimal Style">
                        ...
                        <div class="figure-image__caption section-image__caption hover-zoom__caption section-image__caption-horizontal text-left">
                          <div class="figure-image__wrapper-caption paragraph">Minimal Style</div>
                        </div></a></div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="row flex-wrap">
                        <div class="col-lg-12 col-sm-6 col-12 section-properties__item my-1">
                          <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <div class="figure-info__option small-caps">Client</div>
                            <div class="figure-info__value paragraph">Cassio Architect Agency</div>
                          </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12 section-properties__item my-1">
                          <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <div class="figure-info__option small-caps">Creative Director</div>
                            <div class="figure-info__value paragraph">George Talley</div>
                          </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12 section-properties__item my-1">
                          <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <div class="figure-info__option small-caps">Designers</div>
                            <div class="figure-info__value paragraph">Cathy Porras<br>Reynaldo Newman<br>Anabel Bowling</div>
                          </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12 section-properties__item my-1">
                          <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <div class="figure-info__option small-caps">Developers</div>
                            <div class="figure-info__value paragraph">Phillip Holt<br>Joshua Jenkins</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <section class="container-fluid section section-nav-projects section-fullheight text-center" data-arts-os-animation="data-arts-os-animation">
            <div class="section-fullheight__inner section-nav-projects__inner_actual">
              <header class="section-nav-projects__header"><a class="section-nav-projects__link" href="project-details-1-fullscreen-center.html" data-pjax-link="flyingImage">
                  <div class="section-nav-projects__subheading small-caps mb-1 mb-md-2">Next Project</div>
                  <h2 class="section-nav-projects__heading h1 mt-0 mb-0">Nordic Adventure</h2></a></header>
            ...
            <div class="container section-nav-projects__next-image section-fullheight__inner">
              <div class="section-nav-projects__wrapper-image js-transition-img overflow">
                <div class="lazy js-transition-img__transformed-el"><img class="of-cover" src="#" data-src="img/assets/projects/project-1.jpg" alt="" width="1920" height="1280"/></div>
              </div>
            </div>
