    ...
    <div data-barba="wrapper">
      ...
      <div class="js-smooth-scroll bg-dark-2" id="page-wrapper" data-barba="container">
        <main class="page-wrapper__content">
          <!-- section MASTHEAD -->
          <section class="section section-masthead d-none" data-background-color="#0b0b0b"></section>
          <!-- - section MASTHEAD -->
          <!-- section PROJECTS SLIDER HALFSCREEN -->
          <section class="section section-fullheight section-projects section-projects-slider bg-dark-2 overflow" data-arts-theme-text="light" data-arts-os-animation>
            <div class="section-fullheight__inner section-fullheight__inner_mobile text-center">
              <div class="slider slider-fullscreen-projects js-slider-fullscreen-projects js-slider">
                ...
                <div class="slider-fullscreen-projects__content swiper-container js-slider-fullscreen-projects__content">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Nordic Adventure</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Sunrise in Desert</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">La Isla Bonita</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Dancing in the Dark</h2>
                    </div>
                  </div>
                </div>
                <!-- - slider CONTENT -->
                ...
                <div class="slider-fullscreen-projects__footer swiper-container js-slider-fullscreen-projects__footer">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-1-fullscreen-center.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover">Explore Project</span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-2-bottom-center.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover">Explore Project</span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-9-fullscreen-center.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover">Explore Project</span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-11-fullscreen-center.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover">Explore Project</span></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <!-- - slider COUNTER -->
                <!-- slider IMAGES -->
                <div class="slider-fullscreen-projects__images swiper-container js-slider-fullscreen-projects__images" data-speed="800" data-slides-per-view="1.6" data-slides-per-view-tablet="1.4" data-slides-per-view-mobile="1" data-mousewheel-enabled="true" data-direction="horizontal" data-touch-ratio="3" data-autoplay-enabled="true" data-autoplay-delay="6000" data-drag-mouse="true" data-drag-cursor="true" data-drag-class="slider-fullscreen-projects__images_scale-down">
                  <div class="swiper-wrapper">
                      ...
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle border-radius-100 js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          ...
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-1.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle border-radius-100 js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-2.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle border-radius-100 js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-9.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle border-radius-100 js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-11.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                ...
                <!-- - slider IMAGES -->
                <!-- overlay -->
                <div class="slider__overlay overlay overlay_dark z-50"></div>
