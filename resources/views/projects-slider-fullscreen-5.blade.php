              ...
              <div class="slider slider_reveal slider-fullscreen-projects js-slider-fullscreen-projects js-slider-reveal js-slider text-center">
                ...
                <div class="slider-fullscreen-projects__content swiper-container js-slider-fullscreen-projects__content">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" data-category="branding"><a class="d-inline-block" href="project-details-4-halfscreen-left-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Nothern Wave</h2></a></div>
                    <div class="swiper-slide" data-category="product-design"><a class="d-inline-block" href="project-details-7-fullscreen-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Silence &amp; Noise</h2></a></div>
                    <div class="swiper-slide" data-category="identity"><a class="d-inline-block" href="project-details-8-halfscreen-right-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Minimalex Cosmetics</h2></a></div>
                    <div class="swiper-slide" data-category="photography"><a class="d-inline-block" href="project-details-10-halfscreen-left-right.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Kinsey Premium Furniture</h2></a></div>
                    <div class="swiper-slide" data-category="portraits"><a class="d-inline-block" href="project-details-11-fullscreen-center.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Dancing in the Dark</h2></a></div>
                    <div class="swiper-slide" data-category="portraits"><a class="d-inline-block" href="project-details-12-bottom-container-center.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">The Silent Listener</h2></a></div>
                  </div>
                </div>
                <!-- - slider CONTENT -->
                <!-- slider FOOTER -->
                <div class="container-fluid slider-fullscreen-projects__footer">
                  <div class="row justify-content-between">
                    ...
                    <div class="col-lg-4 text-center text-lg-right order-lg-2">
                      <!-- slider CATEGORIES -->
                      <div class="slider-categories js-slider__categories text-center text-lg-right">
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="branding">Branding</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="product-design">Product Design</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="identity">Identity</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="photography">Photography</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="portraits">Portraits</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-category="portraits">Portraits</div>
                        <div class="slider-categories__category small-caps js-split-text split-text" data-split-text-type="lines" data-button="data-button">Explore Project</div>
                      </div>
                      <!-- - slider CATEGORIES -->
                    </div>
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-4.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-7.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-8.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-10.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-11.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow">
                        <div class="slider__bg swiper-lazy js-transition-img__transformed-el" data-background="img/assets/projects/project-12.jpg"></div>
                      </div>
                    </div>
                  </div>
                  <!-- overlay-->
