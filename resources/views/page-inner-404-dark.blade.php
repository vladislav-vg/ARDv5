    ...
    <div data-barba="wrapper">
      ...
      <div class="js-smooth-scroll bg-dark-1" id="page-wrapper" data-barba="container" data-arts-theme-text="light">
        <main class="page-wrapper__content">
          ...
          <!-- - section MASTHEAD -->
          <!-- section 404 -->
          <section class="section section-404 section-content section-fullheight overflow" data-arts-theme-text="light">
              ...
              <div class="container">
                <div class="row justify-content-center text-center">
                  <div class="col-lg-8">
                    ...
                    <div class="w-100"></div>
                    <div class="section-content__button mt-2 mt-md-3"><a class="button button_bordered button_white" data-hover="Back to Homepage" href="index.html"><span class="button__label-hover">Back to Homepage</span></a>
                    </div>
                  </div>
                </div>
              </div>
