              ...
              <div class="slider slider-fullscreen-projects js-slider-fullscreen-projects js-slider">
                ...
                <div class="slider-fullscreen-projects__content slider-fullscreen-projects__content_reduced-sides swiper-container js-slider-fullscreen-projects__content">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-8-halfscreen-right-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Minimalex Cosmetics</h2>
                        <div class="slider__wrapper-button mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-11-fullscreen-center.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Dancing in the Dark</h2>
                        <div class="slider__wrapper-button mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-12-bottom-container-center.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">The Silent Listener</h2>
                        <div class="slider__wrapper-button mt-0-5">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
                            <div class="change-text-hover__normal js-split-text split-text js-change-text-hover__normal" data-split-text-type="lines" data-split-text-set="lines">Portraits</div>
