                  ...
                  <div class="row h-100 justify-content-between">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg" data-texture-src="img/assets/projects/project-1_vertical.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg" data-texture-src="img/assets/projects/project-5_vertical.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg" data-texture-src="img/assets/projects/project-9_vertical.jpg"></div>
                            </div>
                          </div>
                          <div class="swiper-slide overflow">
                            <div class="slider__images-slide-inner" data-swiper-parallax="90%">
                              <div class="slider__bg" data-texture-src="img/assets/projects/project-11_vertical.jpg"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 align-self-lg-end slider-halfscreen-projects__col">
                      ...
                      <div class="slider-halfscreen-projects__content swiper-container js-slider-fullscreen-projects__content">
                        <div class="swiper-wrapper">
                          <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-1-fullscreen-center.html">
                          ...
                          <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-5-bottom-container-center.html">
                          ...
                          <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-9-fullscreen-center.html">
                          ...
                          <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-11-fullscreen-center.html">
