      ...
      <header class="header header_menu-right header_fixed container-fluid js-header-sticky" id="page-header" data-arts-theme-text="light" data-arts-header-sticky-theme="bg-dark-2" data-arts-header-logo="secondary" data-arts-header-sticky-logo="secondary" data-arts-header-overlay-theme="dark" data-arts-header-overlay-background="#000">
        ...
        <div class="header__container header__controls">
          <div class="row justify-content-between align-items-center">
            <!-- logo -->
            <div class="col-auto header__col header__col-left"><a class="logo" href="home.php">
                <div class="logo__wrapper-img">
                  <!-- primary logo version (for light backgrounds)--><img class="logo__img-primary" src="img/ard/logo.png" alt="ARD HTML5 Template" height="20" style="height: 5rem; width: auto;"/>
                  <!-- secondary logo version (for dark backgrounds)--><img class="logo__img-secondary" src="img/ard/logo-white.png" alt="ARD HTML5 Template" height="20" style="height: 5rem; width: auto;"/>
                </div></a>
            </div>
            <!-- - logo -->
            <!-- burger icon -->
            ...
            <div class="row">
              ...
              <div class="col-lg-4 header__widget">
                ...
                <div class="header__widget-content js-split-text split-text" data-split-text-type="lines">
                  <p><a href="ARD@example.com">ard_md@hotbox.ru</a><br/>(+373 22) 888060<br/>
                  </p>
                </div>
              </div>
              <!-- - widget TEXT -->
              ...
              <div class="col-lg-4 header__widget">
                ...
                <div class="header__widget-content js-split-text split-text" data-split-text-type="lines">
                  <p>Tigina, 49/3, office 37<br/>Kishinev<br/>MOLDOVA<br/>
                  </p>
                </div>
              </div>
              <!-- - widget TEXT -->
                ...
                <div class="slider-fullscreen-projects__content swiper-container js-slider-fullscreen-projects__content">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Sky Tower</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Graphic project</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Malldova</h2>
                    </div>
                    <div class="swiper-slide">
                      <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars">Project for Administative block</h2>
                    </div>
                  </div>
                </div>
                <!-- - slider CONTENT -->
...
<!--                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/assets/projects/project-1.jpg"></div>-->
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/ard/photo/ard-sky-tower.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
<!--                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/assets/projects/project-2.jpg"></div>-->
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/ard/photo/ard-craft.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
<!--                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/assets/projects/project-9.jpg"></div>-->
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/ard/photo/mall-photo.jpg"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
<!--                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/assets/projects/project-11.jpg"></div>-->
                          <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/ard/photo/tpl-slider.jpg"></div>
                      </div>
                    </div>
                  </div>
                  <!-- overlay -->
