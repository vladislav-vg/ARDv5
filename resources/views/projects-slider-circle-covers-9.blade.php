          ...
          <section class="section section-fullheight section-projects section-projects-slider bg-light-3 overflow" data-arts-os-animation>
            <div class="section-fullheight__inner section-fullheight__inner_mobile">
              <div class="slider slider-fullscreen-projects js-slider-fullscreen-projects js-slider">
                <!-- slider IMAGES -->
                <div class="slider-fullscreen-projects__images swiper-container js-slider-fullscreen-projects__images" data-speed="800" data-slides-per-view="1.2" data-slides-per-view-tablet="1.2" data-slides-per-view-mobile="1.2" data-mousewheel-enabled="true" data-direction="vertical" data-touch-ratio="3" data-autoplay-enabled="true" data-autoplay-delay="6000" data-drag-mouse="true" data-drag-cursor="true" data-drag-class="slider-fullscreen-projects__images_scale-down">
                      ...
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          ...
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-3.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-4.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-6.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide overflow d-flex-centered">
                      <div class="slider__images-slide-inner slider__images-slide-inner_circle js-transition-img">
                        <div class="w-100 h-100" data-swiper-parallax-zoom="50%" data-swiper-parallax="10%">
                          <!-- zoom on drag container -->
                          <div class="slider__zoom-container w-100 h-100 overflow">
                            <div class="slider__bg swiper-lazy lazy-bg js-transition-img__transformed-el" data-background="img/assets/projects/project-7.jpg"></div>
                          </div>
                          <!-- - zoom on drag container -->
                        </div>
                      </div>
                ...
                <!-- - slider IMAGES -->
                <!-- slider CONTENT -->
                <div class="slider-fullscreen-projects__content slider-halfscreen-projects__content p-0 slider-fullscreen-projects__content_reduced-sides swiper-container js-slider-fullscreen-projects__content">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-3-halfscreen-left-right.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Cassio Apartment</h2>
                        <div class="slider__wrapper-button mt-1">
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-4-halfscreen-left-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Nothern Wave</h2>
                        <div class="slider__wrapper-button mt-1">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-6-bottom-fullwidth.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Paysage Fiction</h2>
                        <div class="slider__wrapper-button mt-1">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
                    ...
                    <div class="swiper-slide"><a class="d-inline-block js-change-text-hover" href="project-details-7-fullscreen-left.html" data-pjax-link="fullscreenSlider">
                        <h2 class="h1 slider__heading js-split-text" data-split-text-type="lines, words, chars" data-split-text-set="chars">Silence &amp; Noise</h2>
                        <div class="slider__wrapper-button mt-1">
                          <div class="change-text-hover small-caps js-change-text-hover">
                            <!-- label by default -->
